...
import graspop_artists
import graspop_auth
import graspop_playlist
import json
import spotipy
...
if __name__ == '__main__':
    ...
    if playList_not_null:
        ...
        song_list = graspop_playlist.add_top_track_to_playlist(artists_names, access_token)
        snapshot_id = [sp.user_playlist_add_tracks(user_id, playlist['id'], song_list[:99]),
                       sp.user_playlist_add_tracks(user_id, playlist['id'], song_list[99:], position=99)]
    print(playlist['id'])
